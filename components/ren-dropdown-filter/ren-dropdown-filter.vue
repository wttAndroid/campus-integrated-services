        ...
        <view class="inner-wrapper">
            ...
            <view class="navs">
                <view class="c-flex-align" :class="{ 'c-flex-center': index > 0, actNav: index === actNav }" v-for="(item, index) in navData" :key="index" @click="navClick(index)">
                   ...
                   <image src="https://i.loli.net/2020/07/15/QsHxlr1gbSImvWt.png" mode="widthFix" class="icon-triangle" v-if="index === actNav"></image>
                    <image src="https://i.loli.net/2020/07/15/xjVSvzWcH9NO7al.png" mode="widthFix" class="icon-triangle" v-else></image>
                </view>
