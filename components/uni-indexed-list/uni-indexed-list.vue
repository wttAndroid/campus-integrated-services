	...
	<view class="uni-indexed-list" ref="list" id="list">
		...
		<list class="uni-indexed-list__scroll" scrollable="true" show-scrollbar="false">
			<cell v-for="(list, idx) in lists" :key="idx" :ref="'uni-indexed-list-' + idx">
				<!-- #endif -->
				<!-- #ifndef APP-NVUE -->
				<scroll-view :scroll-into-view="scrollViewId" :refresher-triggered="triggered" @refresherrefresh="refresherrefresh" :refresher-enabled="true" class="uni-indexed-list__scroll" scroll-y>
...
<script>
	...
	import indexedListItem from './uni-indexed-item.vue'
	// #ifdef APP-NVUE
		...
		methods: {
			...
			onClick(e) {
				...
				this.$emit('click', {
					item: obj,
					select: select,
					uid:this.lists[idx].items[index]['name']['uid']
				})
			}
		}
	}
